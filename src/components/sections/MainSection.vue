      ...
      <div class="flex flex-col justify-between gap-6">
        <div data-gsap-reveal>
          ...
          <div class="mt-5 sm:mt-6 flex flex-wrap gap-3">
            <a href="/resume.pdf"
               download
               class="inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl bg-cinnabarMain text-sm font-medium hover:brightness-110 transition shadow-lg shadow-cinnabarMain/20">
